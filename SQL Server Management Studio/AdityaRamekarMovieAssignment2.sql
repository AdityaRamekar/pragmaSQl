...
--actor,movie_cast,movie
--count mov_id
--count gender 'M' and gender 'F' in mov_id
--male actor name,female actor name,count of films
SELECT act_fname as MaleActor,act_fname as FemaleActor,count(movie.mov_id) as AppearanceCount FROM actor
join movie_cast on actor.act_id = movie_cast.act_id
join movie on movie_cast.movie_id = movie.mov_id
WHERE act_gender = 'f' and act_gender = 'm' 
order by actor.act_id;
/*
